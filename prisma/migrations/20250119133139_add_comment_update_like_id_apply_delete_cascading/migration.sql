...
INSERT INTO "new_Tweet" ("created_at", "id", "photo", "photoHeight", "photoWidth", "tweet", "updated_at", "userId") SELECT "created_at", "id", "photo", "photoHeight", "photoWidth", "tweet", "updated_at", "userId" FROM "Tweet";
DROP TABLE "Tweet";
